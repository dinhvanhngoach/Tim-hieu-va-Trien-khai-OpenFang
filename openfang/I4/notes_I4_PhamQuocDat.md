# NOTES.MD — NHÓM OPENFANG
## Tuần học: Tìm hiểu & Triển khai OpenFang
## Mục tiêu: Build 2 agent OpenFang phối hợp nhau

---

## I4 — Phạm Quốc Đạt — Ghi chú về Agent trong OpenFang
...
---
*Ghi chú bởi: I4 — Phạm Quốc Đạt | Ngày 1 — Thứ Hai*
